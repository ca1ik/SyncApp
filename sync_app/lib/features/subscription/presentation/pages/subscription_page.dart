              ...
              child: Column(
                children: [
                  ...
                  _ProFeatureCard(
                    icon: '🤖',
                    title: l.tr(
                        'Unlimited AI Assistants', 'Sinirsiz AI Asistanlar'),
                    description: l.tr(
                        'Use relationship coach and astrology assistant without daily limits.',
                        'Iliski kocu ve burc asistanini gunluk limit olmadan kullanin.'),
                    theme: theme,
                  ).animate().fadeIn(delay: 600.ms).slideX(begin: -0.1),
                  const Gap(12),
                  _ProFeatureCard(
                    icon: '🎮',
                    title: l.tr('All Games', 'Tum Oyunlar'),
                    description: l.tr(
                        'Access all couple games including exclusive PRO arena games.',
                        'PRO arena oyunlari dahil tum cift oyunlarina erisin.'),
                    theme: theme,
        ...
        child: Column(
          children: [
            ...
            _row(l.tr('Daily mood entries', 'Gunluk mood girisi'),
                l.tr('10 / day', '10 / gun'), l.tr('Unlimited', 'Sinirsiz')),
            const Divider(height: 16),
            _row(l.tr('Mood history', 'Mood gecmisi'),
                l.tr('Last 30', 'Son 30'), l.tr('All', 'Tumu')),
            const Divider(height: 16),
            ...
            _row(
                ...
                l.tr('3 techniques', '3 teknik'),
                l.tr('All techniques', 'Tum teknikler')),
            const Divider(height: 16),
            _row(l.tr('Deep insights', 'Derin icgorular'),
                l.tr('Basic', 'Temel'), l.tr('✅ Full', '✅ Tam')),
            const Divider(height: 16),
            _row(
                l.tr('AI Assistants', 'AI Asistanlar'),
                l.tr('1/day each', 'Her biri 1/gun'),
                l.tr('Unlimited', 'Sinirsiz')),
            const Divider(height: 16),
            _row(l.tr('Games', 'Oyunlar'), l.tr('18 games', '18 oyun'),
                l.tr('All games', 'Tum oyunlar')),
            const Divider(height: 16),
            _row(l.tr('Special achievements', 'Ozel basarimlar'),
                l.tr('Most', 'Cogu'), l.tr('All', 'Tumu')),
            const Divider(height: 16),
